...
const Footer: React.FC = () => {
  ...
  const socialLinks = [
    { icon: <Linkedin className="h-5 w-5" />, href: 'https://www.bing.com/ck/a?!&&p=f7d4505eab487bcf20ddb74fbc19a010292913d148137f01d4a3fa7a04028f9bJmltdHM9MTc0OTI1NDQwMA&ptn=3&ver=2&hsh=4&fclid=09f1fc4d-1497-6d8d-0718-eed4153a6cb4&psq=vivarancreations+linkedin&u=a1aHR0cHM6Ly93d3cubGlua2VkaW4uY29tL2NvbXBhbnkvdml2YXJhbi1jcmVhdGlvbnMv&ntb=1', name: 'LinkedIn' },
  ];
